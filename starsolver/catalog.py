...
# ── Constellation lines (Stellarium, GPL license) ────────────────────────────
# Format: [abbr, num_segments, HIP_a, HIP_b, HIP_c, HIP_d, ...]
...
# All HIP IDs referenced by constellation lines
_ALL_HIP_IDS: set = set()
